...
<main>
    ...
    <div class="container mt-2">
      <h1 class="title-big thin text-center">Избранное</h1>
      <div class="row compare-header">
        <div class="col-4 hidden-lg-down uppercase bold compare-header--filter" style="visibility: hidden;"><a href="" class="pink">Добавленные недавно</a></div>
        <div class="col-12 col-lg-4 text-center thin compare-header--saved">Ваши товары будут сохраняться в течение 60 дней</div>
      ...
      <div class="row favorite-body">
        <div class="teaser teaser-normal text-center product-item col-6 col-lg-3 col-md-4" data-product="84">
          <div class="compare-cell pt-1">
            <div class="teaser-inner position-relative">
              ...
              <div class="text-normal thin text-center p-x-1 teaser-item--name"><span>Подарочный набор Гармония</span></div>
              ...
              <div class="text-normal text-center p-x-1 pink bold teaser-item--volume">тюбик 120 мл</div>
              
              <div class="button-trash-wrapper absolute">
        ...
        <div class="teaser teaser-normal text-center product-item col-6 col-lg-3 col-md-4" data-product="84">
          <div class="compare-cell pt-1">
            <div class="teaser-inner position-relative">
              <div class="teaser-image">
                <a href="/product/подарочный-набор-гармония"><img class="teaser-img img-fluid center-block" src="http://blackpearl.e-produce.ru/sites/default/files/styles/teaser_normal/public/products/podarochnyi_nabor_voshishchenie_1.png?itok=3LYI9ZPV" alt="Black Pearl" title="Black Pearl"></a>
              </div>
