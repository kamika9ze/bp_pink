...
include_once('inc/bp_header.tpl.php'); 
...
<main class="main-checkout">
	...
	<h1 class="thin text-center">Оформить заказ</h1>
	<div class="cart-tabs justify-wrap checkout-cart-tabs">
		<div class="cart-tabs-link active cart">
		1. Моя корзина    	</div>
		<div class="cart-tabs-link next active checkout">
		2. Способ доставки    	</div>
		<div class="cart-tabs-link shipping active-link">
		3. Способ оплаты    	</div>
		<div class="cart-tabs-link review">
		4. Подтверждение    	</div>
		<!-- <div class="cart-tabs-link complete">5. Окончание</div> -->
	...
	<div id = "shipping-checkout-form">
		<div id="block-system-main" class="block block-system checkout-form-cart">
			<form action="/checkout/1196" method="post" id="commerce-checkout-form-checkout" accept-charset="UTF-8">
				<div class="cart-form-section">
					<div class="cart-box-container">
						<div class="cart-form-title">Способ оплаты</div>
						<div class="col-xs-12">
							<div id="edit-bp-commerce-delivery-type-choose" class="form-radios">
								<div class="col-sm-6 col-xs-12 form-item form-type-radio form-item-bp-commerce-delivery-type-choose">
									<input type="radio" id="edit-bp-commerce-delivery-type-choose-322" name="bp_commerce[delivery_type_choose]" value="322" checked="checked" class="form-radio error ajax-processed checked_el">  <label class="option" for="edit-bp-commerce-delivery-type-choose-322" style="opacity: 1;">Наличными или банковской картой при получении</label>

								</div>
								<div class="col-sm-6 col-xs12 form-item form-type-radio form-item-bp-commerce-delivery-type-choose">
								<input type="radio" id="edit-bp-commerce-delivery-type-choose-392" name="bp_commerce[delivery_type_choose]" value="392" class="form-radio error ajax-processed">  <label class="option" for="edit-bp-commerce-delivery-type-choose-392" style="opacity: 1;">Банковской картой онлайн</label>
				...
				<fieldset class="col-sm-12 col-xs12 checkout-buttons form-wrapper cart-box-container" id="edit-buttons">
					<div class="fieldset-wrapper">
						<div class="col-sm-6 col-xs-12"><input class="checkout-continue form-submit checkout-processed" type="submit" id="edit-continue" name="op" value="Продолжить"></div>
						<div class="col-sm-6 col-xs-12"><input class="checkout-cancel form-submit" type="submit" id="edit-cancel" name="op" value="Отмена"></div>
					</div>
				</fieldset>
			</form>
		</div>
	...
	<div class="box-container-tab-checkout">
		<div class="block-container-tab-checkout">
			<nav class="nav nav-pills">
		        ...
		        <a class="nav-link nav-item" data-toggle="tab" href="#fat5">Оплаты</a>
		      ...
		      <div class="tab-content checkout-tab-content" role="tabpanel">
		        <div role="tabpanel" class="tab-pane fade show active" id="home5">
			      	<nav class="nav nav-pills-tabs">
				        ...
				        <a class="nav-link nav-item" data-toggle="tab" href="#forgot-password">Забыли пароль?</a>
				    </nav>
		        ...
		        <div role="tabpanel" class="tab-pane fade" id="profile5">
					...
					<ul class="delivery-menu">
						<li><a href="#">Карта пунктов выдачи заказов</a></li>
						<li><a href="#" class="active">Курьерская доставка</a></li>
