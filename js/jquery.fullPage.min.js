    ...
    ma = {
        ...
        create: function(c, d) {
			...
			c.find(".fp-scrollable").slimScroll({
				...
				var posY = $(".footer .legal").offset().top - $("#section2 .fp-scrollable").height();
				//console.log($(".footer .legal").position().top + " - " + $("#section2 .fp-scrollable").height() + " - " + pos + " " + posY); //$(".footer .legal").position().top
				//if ($(".footer .legal").position().top > pos) { //+$('.js-legal-fixed').height()
				if ((posY - $('.js-legal-fixed').height()) > 0) { //+$('.js-legal-fixed').height()
					$(".js-legal-fixed").removeClass('closed');
				} else {
					$(".js-legal-fixed").addClass('closed');
				}
			});
        },
